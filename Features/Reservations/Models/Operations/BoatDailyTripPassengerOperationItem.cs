...
public class BoatDailyTripPassengerOperationItem
{
    public Guid BoatDailyTripId { get; set; }

    public Guid? OutboundPassengerTripId { get; set; }
    public Guid? ReturnPassengerTripId { get; set; }
    ...
    public bool HasOutbound => OutboundPassengerTripId.HasValue;
    public bool HasReturn => ReturnPassengerTripId.HasValue;
